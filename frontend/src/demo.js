...
function route(path) {
  ...
  if (path.endsWith("/api/config")) return { korean_mode: false, experimental_mode: false, cover_sources: { libretro: true, igdb: false, tgdb: false, sgdb: false } };

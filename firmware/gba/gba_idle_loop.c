...
static const gba_idle_entry_t GBA_IDLE_LOOPS[] = {
    ...
    { "AINJ", 0x8000400, 10204 },   // 이니셜D 어나더 스테이지 (Initial D - Another Stage)
    ...
    { "AGXE", 0x8000332, 16497 },   // 길티 기어 X 어드밴스 에디션 (Guilty Gear X - Advance Edition)
    { "A3CE", 0x8016234, 17119 },   // 크레이지택시 (Crazy Taxi - Catch a Ride)
    { "AYPE", 0x3005d18, 19150 },   // 세가 아케이드 갤러리 (SEGA Arcade Gallery)
    { "A2DJ", 0x8001b0e, 21668 },   // 다리우스 R
    { "ASBJ", 0x8000252, 24249 },   // 역전재판
    ...
    { "BKCS", 0x80006b8, 46940 },   // 짱구는 못말려 - 시네랜드의 모험 (Shin chan - Aventuras en Cineland)
    { "A3GJ", 0x8000262, 47884 },   // 역전재판 2 (Gyakuten Saiban 2)
    ...
    { "BATE", 0x80879f8, 65403 },   // 배트맨 - 라이즈 오브 신 츠
    ...
    { "A29J", 0x8006a9e, 67600 },   // 미키와 미니의 매지컬퀘스트2
    ...
    { "BHRJ", 0x8013f60, 72938 },   // 강철의 연금술사 - 미주의 윤무곡 (Hagane no Renkinjutsushi - Meisou no Rondo)
    ...
    { "AFFJ", 0x8005e08, 76363 },   // 파이널 파이트 원 (Final Fight One)
    ...
    { "BU6J", 0x801da38, 84542 },   // 대결! 울트라 히어로 (Taiketsu! Ultra Hero)
    ...
    { "BM3J", 0x80028fc, 87392 },   // 미키와 도날드의 매지컬 퀘스트3
    { "U32J", 0x8229e94, 88333 },   // 우리들의 태양2 - 속 우리들의 태양
    { "BNJJ", 0x803622c, 89634 },   // 쟈쟈마루 쥬니어 전승기
    { "AMZE", 0x8001cfc, 89918 },   // 슈퍼마리오USA
    ...
    { "BFCJ", 0x80006b4, 95128 },   // 판타직 칠드런
    { "BSME", 0x8000298, 96147 },   // 메탈슬러그 어드밴스 (Metal Slug Advance)
    { "AXBJ", 0x8000372, 96870 },   // 블랙 매트리스 제로
    { "BKCJ", 0x80006b8, 97481 },   // 짱구는 못말려 - 폭풍을 부르는 시네마랜드의 대모험 (Crayon Shin-chan - Arashi o Yobu Cinemaland no Daibouken!)
    ...
    { "BGXJ", 0x8000852, 109232 },   // 건스타 슈퍼 히어로즈 (Gunstar Super Heroes)
    ...
    { "BH2J", 0x801d84c, 123434 },   // 강철의 연금술사 - 추억의 주명곡 (Hagane no Renkinjutsushi - Omoide no Sonata)
    ...
    { "A9TJ", 0x80671e0, 131741 },   // 메탈맥스 2 카이 (Metal Max 2 Kai)
    ...
    { "BSAJ", 0x8003540, 171663 },   // 슈퍼 차이니즈 1+2 어드밴스 (Super Chinese 1, 2 Advance)
